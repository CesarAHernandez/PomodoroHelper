...
export default class HomePage extends React.PureComponent {
  ...
  removeOption = () => {
    this.setState({
      timeOptions: [
        ...this.state.timeOptions.slice(0, this.state.timeOptions.length - 1),
      ],
      restOptions: [
        ...this.state.restOptions.slice(0, this.state.restOptions.length - 1),
      ],
    });
  };
  handleChange = (e, key) => {
    if (e.target.name === 'timeOptions') {
      ...
      const [restOptions] = this.state.restOptions;
    ...
    return (
      <div>
        <div id="summary">
          ...
          <p>
            The usual times that people choose is 20mins work 5mins rest 20mins
            work 5mins rest 20mins work 15mins rest, then restart
          </p>
        </div>
        <InputField
